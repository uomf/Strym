...
function BtnStartSlot() {
    return(
        <button className='bg-red shadow-[0px_0px_16px_0px_rgba(255,37,59,0.50)] text-white items-center flex flex-row gap-1 z-20 px-4 py-3 rounded-full font-semibold text-lg'>
...
export default function BottomButton({isLiked, numOfLikes, isMarked, isSlotMachine, handleLike, handleBookmark}) {
    return(
